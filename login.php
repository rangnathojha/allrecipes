...
$gt_msgerror= "";
if($_GET["services_package_id"]>0)
{
	$_SESSION["services_package_id"] = $_GET["services_package_id"];
}
...
<p>If you do not find the mail in your Inbox, please check your Spam or Junk folder.</p></div>';
			...
			else
			{
				...
				$_SESSION['GTUserProfileID']		=	$row["oauth_uid"];	
				$_SESSION['GTUserLoginFrom']		=	$row["oauth_provider"];	
				$_SESSION['GTUserphotograph']		=	$row["photograph"];	
				...
				$query_update_logintime = "UPDATE `ss_users` SET `last_login` = $gtcurrenttime WHERE `user_id` =".$row["id"];
    ...
    <div class=" col-sm-offset-4 col-sm-4 ">
    	<div class="rws-userformdesign">
            ...
            <?php 	echo $gt_msgerror; 	
					...
					if($_GET["services_package_id"]>0)
					{
						echo '<div id="rws-forminfo">To complete purchase, please <strong>login</strong> if you are an existing customer or <strong>sign up</strong> if you\'re a new one.</div>';
					}
			?>
            
            <form action="" method="post" enctype="multipart/form-data" name="gtregisterforms" id="gtregisterforms">
        	<div class="rws-fields">    
                <input type="email" name="rwsusername" id="rwsusername" value="" placeholder="*Email ID" required />    
            </div>
            <div class="rws-fields">    
            ...
            <div class="rws-fields" style="text-align:center;">
                <a href="social-login.php?user=C&amp;social=facebook" class="rwssocialbtn rwsfacebook"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="social-login.php?user=C&amp;social=google" class="rwssocialbtn rwsgoogle"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="social-login.php?user=C&amp;social=twitter" class="rwssocialbtn rwstwitter"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            </div>
    
            <div class="rws-fields">
                <div class="row">
                	<div class="col-sm-6 margin_bottom_20"><a href="forget-password.php"  class="rwsbutton rwsbuttongray width_100" style="font-size:14px; padding:5px 10px;">Forgot Password?</a></div>
                    <div class="col-sm-6" style="text-align:right;"><a href="register-as-service-consumer.php" class="rwsbutton width_100" style="font-size:14px; padding:5px 10px; ">Register</a></div>
                </div>
            </div>
            
            <div class="rws-fields">
           	By logging in, you agree to our <a href="http://www.shapingsteps.com/terms-of-service-for-services/" target="_blank">Terms of Service</a> and <a href="http://www.shapingsteps.com/privacy-policy/" target="_blank">Privacy Policy</a>.</div>
